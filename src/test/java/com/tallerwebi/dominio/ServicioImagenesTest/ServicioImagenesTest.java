...
public class ServicioImagenesTest {
  ...
  public void subirImagenHijoDeberiaAplicarTransformacionYRetornarUrl() throws IOException {
    ...
    resultadoSimulado.put(
      "secure_url",
      "https://res.cloudinary.com/kionet/image/upload/carnet_hijo.jpg"
    );
    ...
    assertThat(
      urlObtenida,
      equalTo("https://res.cloudinary.com/kionet/image/upload/carnet_hijo.jpg")
    );
    ...
    assertThat(
      transformacionString.contains("width_400") || transformacionString.contains("w_400"),
      equalTo(true)
    );
    assertThat(
      transformacionString.contains("height_400") || transformacionString.contains("h_400"),
      equalTo(true)
    );
    assertThat(
      transformacionString.contains("crop_thumb") || transformacionString.contains("c_thumb"),
      equalTo(true)
    );
    assertThat(
      transformacionString.contains("gravity_face") || transformacionString.contains("g_face"),
      equalTo(true)
    );
  }
